...
# Define os caminhos no S3 para os arquivos, seguindo o padrão:
# <nome do bucket>/<camada de armazenamento>/<origem do dado>/<formato do dado>/<especificação do dado>/<data separada por ano/mês/dia>/<arquivo>".
